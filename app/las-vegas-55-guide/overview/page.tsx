          ...
          <div className="space-y-6 text-muted-foreground">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
              <div className="p-6 rounded-lg border bg-card">
                ...
                <p>
                  Consider proximity to healthcare facilities, shopping centers, entertainment venues, and airports. Summerlin and Henderson are particularly popular areas, offering master-planned communities with excellent amenities and convenient access to everything Las Vegas has to offer. Think about your transportation needs and whether you want to be within walking distance of services or comfortable driving to destinations.
                </p>
              </div>
              <div className="p-6 rounded-lg border bg-card">
