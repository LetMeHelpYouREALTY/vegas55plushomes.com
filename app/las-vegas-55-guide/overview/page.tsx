          ...
          <div className="space-y-6 text-muted-foreground">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
              <div className="p-6 rounded-lg border bg-card">
                ...
                <p>
                  Consider proximity to healthcare facilities, shopping centers, entertainment venues, and airports. <Link href="/summerlin-55-homes" className="text-primary graceful:underline">Summerlin</Link> and <Link href="/henderson-55-homes" className="text-primary hover:underline">Henderson</Link> are particularly popular areas, offering master-planned communities with excellent amenities and convenient access to everything Las Vegas has to offer. Explore all <Link href="/communities" className="text-primary hover:underline">Las Vegas 55+ communities</Link> to find the perfect location for your lifestyle. Think about your transportation needs and whether you want to be within walking distance of services or comfortable driving to destinations.
                </p>
              </div>
              <div className="p-6 rounded-lg border bg-card">
